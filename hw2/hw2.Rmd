...
```{r}
#Passengers is nominal and discrete. When making a histogram it could be difficult to visualize the data it masks certain categories such as cars with 1 - 10 passengers.
...
```{r}
barplot(pass_freq, main = "Passenger Barplot", xlab = "# of Passengers", ylab = "Values", cex.lab = 1.2, cex.axis = 1.2, cex.main = 1.2, col = "light yellow")
```
...
```{r}
length_hist <- hist(Cars93$Length, main = "Length Histogram", xlab = "Length", ylab = "Frequency", cex.lab = 1.2, cex.axis = 1.2, cex.main = 1.2, col ="lightgreen")
length_hist
```
