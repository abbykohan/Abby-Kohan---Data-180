...
```{r}
barplot(loan_data$Def_ind, main="Indicator of Default Bar Graph", xlab="", ylab="", col="lightyellow", border="black")

```
(b) Plot a bar graph for the “rep_education" column and describe it.  
```{r}
barplot(table(loan_data$rep_education), main="Education Level", xlab="", ylab="", col="lightyellow", border="black")
...
```{r}
hist(loan_data$rep_income, main="Annual Income", xlab="", ylab="", col="grey", border="black")
...
```{r}
boxplot(loan_data$tot_balance, main="Total Available Balance", xlab="", ylab="", col="aquamarine", border="black")
